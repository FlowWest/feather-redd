...
```{r, include=FALSE}
# redd survey points
redd_data <- read.csv("data/redd_observations.csv")
...
# off_channel <- redd_data_zero_removed |> 
#   filter(
