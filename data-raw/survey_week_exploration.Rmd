...
```{r}
redd_observations <- read_csv("data/redd_observations.csv")
```
...
redd_2015_clean <- redd_2015 |> 
    ...
    survey_wk = case_when(
      ...
      survey_wk == "HFWK1" ~ "5", # date: 2015-10-16 #uncomment this because HFWK1 is not a typo
...
redd_2014_clean <- redd_2014 |> 
    ...
    survey_wk = case_when(
      ...
      TRUE ~ str_extract(survey_wk, "[0-9]+"))) #TODO HF and HF2 will stay as survey_week
