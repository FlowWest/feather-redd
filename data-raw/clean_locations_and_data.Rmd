---
title: "feather river redd survey locations and data clean up"
date: "2024-11-06"
output: 
  html_document:
    theme: flatly
...
Summary of work that has been done so far:
  ...
  * *mapping-qc-exploration*: looks into latitude longitude and identifies issues. 
    
  * *clean_locations_and_data*: fixed latitude/longitude provided by Chris Cook, these changes address the issues found on mapping_qc. 
...
write.csv(redd_observations_wnames, "data/redd_observations_survey_wk.csv", row.names = FALSE)
