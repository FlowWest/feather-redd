...
This markdown is a continuation of redd_initial_qc. Issues found on an exploratory markdown (mapping-qc-exploration.Rmd) will be addressed here.

The main goal of this markdown is to clean up the location names from Feather River redd survey data.
