...
spawning_areas_lfc <- c("gateway", "eyeriffle", "steep", "weir", "lowerrobinson", "upperrobinson", "alec")
spawning_areas_hfc <- c("vanceeast", "bigholeeast", "g95eastsidechanneltop", "lowerhour", "keister", "bigbar", "lowermcfarland", "developing")

table_for_crosscheck <- expanded_data |> 
  left_join(all_locations, by = "location") |> 
  mutate(
    spawning_area = case_when(
      survey_group == "gsa" ~ TRUE,
