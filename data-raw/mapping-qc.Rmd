...
```{r, include=FALSE}
# redd survey points
redd_data <- read.csv("data/archive/all_redd_data.csv") #this is the original redd csv that was written on redd_qc_2014_2023.Rmd. I brought it back because some of the fields were deleted manually and therefore broke this code
...
trouble_lat_long <- redd_data |> 
  filter(latitude == 0 |
         longitude == 0) 
# saving those data entries to share with Chris and Casey
write.csv(trouble_lat_long, "data/faulty_lat_long_records.csv")
...
# saving off-channel redd survey locations
