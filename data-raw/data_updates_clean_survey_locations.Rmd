...
name_check_map <- leaflet(data = names_for_check) |> 
  addTiles() |> 
  addCircleMarkers(~longitude, ~latitude, popup = ~location, group = ~location,
                   radius = 2,  # Adjust radius as needed
                   color = "red")

# Add a layer control with checkboxes for each unique location
