...
datatable_metadata <-
  dplyr::tibble(filepath = c("data/feather_redd.csv"),
                ...
                datatable_url = paste0("https://raw.githubusercontent.com/FlowWest/feather-redd/main/data/",
                                       c("survey_characteristics.csv", #TODO update these csv name
...
excel_path <- "data-raw/metadata/feather_redd_project_metadata.xlsx" #TODO check this excel path/name
...
custom_units <- data.frame(id = c("parr marks", "decimal degrees", "decimal degrees", "count of fish", "NTU", "square meters"), #todo update custom units
