...
Add excel file with new data into the dwr_chinook_redd_survey_data folder of your local computer copy following yyyy_Chinook_Redd_Survey_Data.xlsx name convention, replacing "yyyy" with the actual year of the data. Here's the GitHub path: (path)[https://github.com/FlowWest/feather-redd/tree/review-data/data-raw/dwr_chinook_redd_survey_data]

## Processing Data
Data processing is handled by one script located in the data-raw folder called (redd_qc_2014_2023.Rmd)[https://github.com/FlowWest/feather-redd/blob/review-data/data-raw/redd_qc_2014_2023.Rmd]
...
2. After checkin that data is showing properly, 

Run redd_qc_2014_2023.Rmd script located [here](https://github.com/FlowWest/feather-redd/blob/review-data/data-raw/redd_qc_2014_2023.Rmd). Note that every year's data was entered differently, therefore data cleaning was specific to each year. We will adapt this data cleaning process once data entry protocol is unified/consistent.
