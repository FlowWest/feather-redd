...
Data processing is handled by one script located in the [data-raw](https://github.com/FlowWest/feather-redd/blob/main/data-raw) folder:  [redd_qc_2014_2023.Rmd](https://github.com/FlowWest/feather-redd/blob/main/data-raw/redd_qc_2014_2023.Rmd)



1. On the `redd_qc_2014_2023.Rmd` (Change name to `redd_qc.Rmd`??) script, add the following code under line 116 to read new data:
    ```
...
2. After confirming that the data is showing properly, run the `redd_qc_2014_2023.Rmd` script located [here](https://github.com/FlowWest/feather-redd/blob/main/data-raw/redd_qc_2014_2023.Rmd). Note that each year's data was entered differently, so the data cleaning is specific to each year. We will adapt this data cleaning process once the data entry protocol is unified/consistent.
